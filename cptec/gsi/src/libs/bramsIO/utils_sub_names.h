...
#if defined(SUN) || defined(ALPHA) || defined(SGI) || defined (PC_LINUX1) || defined(NEC_SX) || defined(CCE)
...
#define rams_c_open_u rams_c_open_u_
#define rams_c_close rams_c_close_
#define rams_c_close_u rams_c_close_u_
...
#define vfirecr_u vfirecr_u_
#define vforecr vforecr_
#define vforecr_u vforecr_u_
...
#define get_mem_usage get_mem_usage_
