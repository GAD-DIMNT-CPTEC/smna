...
integer(i_kind) :: datein

namelist /nam_enkf/datein,datapath,iassim_order,&
...
! cover date from integer to string:
write(datestring,'(I10)') datein
if(nproc == 0) write(*,*) 'The analysis date is ', datestring
