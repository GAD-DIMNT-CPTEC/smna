...
character(len=256),allocatable,dimension(:):: dvars2d, dvars3d
character(len=256),allocatable,dimension(:):: dsrcs2d, dsrcs3d
!DRScharacter(len=32),allocatable,dimension(:):: dvars2d, dvars3d
!DRScharacter(len=32),allocatable,dimension(:):: dsrcs2d, dsrcs3d
