...
! Loop over levs in profile
       ...
       ! Loop over number of replications of ROSEQ2 nested inside this particular replication of ROSEQ1
           ...
           enddo
           m = (6*nreps_this_ROSEQ2(k))+4
           bend_pccf=data1b(m,k)  ! percent confidence for this ROSEQ1 replication
...
1010 continue
  ...
  write(6,'(A32,L1,1x,I6)')'READ_GPS:  ref_obs,nprof_gps= ',ref_obs,nprof_gps
