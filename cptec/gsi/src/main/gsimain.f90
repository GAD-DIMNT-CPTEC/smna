...
!     satbias_angle.in - satellite angle dependent file
!     satbias.in       - satellite bias correction coefficient file
...
!     satbias.out  - output satellite bias correction file
...
!             IsBRAMS = .true. input is from BRAMS regional model
!
