...
!DRS  character(len=20),dimension(:),allocatable:: dvars2d
!DRS  character(len=20),dimension(:),allocatable:: dvars3d
  character(len=256),dimension(:),allocatable:: dvars2d
  character(len=256),dimension(:),allocatable:: dvars3d
