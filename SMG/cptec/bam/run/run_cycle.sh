...
do
  ...
  then
    ...
    /bin/bash ${data_run}/runPre -v -t 299 -l 64 -np 240 -N 40 -d 1 -I ${data} -p SMT -n 0 -s -G -ti 1534 -li 64 -Gt grid -Gp gblav -O -T
  else
    echo ""
  ...
  /bin/bash ${data_run}/runModel -v -np 800 -N 4 -d 10 -t 299 -l 64 -I ${data} -F ${aux} -W ${aux} -p NMC -s sstwkl -ts 24 -tr 6 
