...
# GSI_EXE  = path and name of the gsi executable 
  ...
  WORK_ROOT=comGSIv3.4_EnKFv1.0/run/testarw
  OBS_ROOT=data/2014061700/obs
  PREPBUFR=${OBS_ROOT}/gdas1.t${HH}z.prepbufr.nr
  BK_ROOT=data/2014061700/arw
  BK_FILE=${BK_ROOT}/wrfinput_d01_ARW_2014-06-17_00
  CRTM_ROOT=CRTM_REL-2.1.3
  GSI_ROOT=comGSIv3.4_EnKFv1.0/
