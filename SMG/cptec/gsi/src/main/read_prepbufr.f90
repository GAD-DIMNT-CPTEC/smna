...
! Declare local variables
  ...
  integer(i_kind) ntest,conta, nvtest,iosub,ixsub,isubsub,iobsub
...
! raob level enhancement on temp and q obs 
           if(ext_sonde .and. kx==120 .and. regional) call sonde_ext(obsdat,tpc,qcmark,obserr,drfdat,levs,kx,vtcd)
...
900 continue
  if(diagnostic_reg .and. ntest>0) write(6,*)'READ_PREPBUFR:  ',&
     'ntest,disterrmax, outside=',ntest,disterrmax, conta
