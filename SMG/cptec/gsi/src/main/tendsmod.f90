...
!DRS  character(len=32),allocatable,dimension(:):: tvars2d, tvars3d
!DRS  character(len=32),allocatable,dimension(:):: tsrcs2d, tsrcs3d
  character(len=256),allocatable,dimension(:):: tvars2d, tvars3d
  character(len=256),allocatable,dimension(:):: tsrcs2d, tsrcs3d
...
!DRScharacter(len=32),allocatable,dimension(:):: vars
!DRScharacter(len=32),allocatable,dimension(:):: sources
character(len=256),allocatable,dimension(:):: vars
character(len=256),allocatable,dimension(:):: sources
