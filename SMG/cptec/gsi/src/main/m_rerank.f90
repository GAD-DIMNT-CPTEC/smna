...
CONTAINS
  ...
  function rerank_3in1r4_(i3) result(i1)
    ...
    interface
       ...
       implicit none
       integer(i_kind),intent(in) :: ln
       real(r_single),dimension(ln),target,intent(in):: i3
       real(r_single),pointer,dimension(:):: i1
       end function rerank_hack_2in1r4_
    end interface
  ...
  function rerank_3in1r8_(i3) result(i1)
    ...
    interface
       ...
       implicit none
       integer(i_kind),intent(in) :: ln
       real(r_double),dimension(ln),target,intent(in):: i3
       real(r_double),pointer,dimension(:):: i1
       end function rerank_hack_2in1r8_
    end interface
...
!----
  function rerank_4in1r4_(i4) result(i1)
    ...
    interface
       ...
       implicit none
       integer(i_kind),intent(in) :: ln
       real(r_single),dimension(ln),target,intent(in):: i4
       real(r_single),pointer,dimension(:):: i1
       end function rerank_hack_2in1r4_
    end interface
  ...
  function rerank_4in1r8_(i4) result(i1)
    ...
    interface
       ...
       implicit none
       integer(i_kind),intent(in) :: ln
       real(r_double),dimension(ln),target,intent(in):: i4
       real(r_double),pointer,dimension(:):: i1
       end function rerank_hack_2in1r8_
    end interface
