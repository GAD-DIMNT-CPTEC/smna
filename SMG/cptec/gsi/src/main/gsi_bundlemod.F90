...
! !INPUT PARAMETERS:
 ...
 character(len=256),intent(in):: names(nd)
...
! !INPUT PARAMETERS:
    ...
    character(len=256),OPTIONAL,intent(in) :: names1d(:) ! 1-d variable names
    character(len=256),OPTIONAL,intent(in) :: names2d(:) ! 2-d variable names
    character(len=256),OPTIONAL,intent(in) :: names3d(:) ! 3-d variable names
