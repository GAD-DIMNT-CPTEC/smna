...
! set passed variables to public
  ...
  public :: hsub,cclimit,el2orc,elocp,h1000,cpr,cpor,p00,pcpeff0,pcpeff2,delta,pcpeff1
...
! Numeric constants
  ...
  real(r_kind),parameter:: pp         = 1.e5_r_kind ! Sea level standard atmospheric pressure [Pa] ??
...
!   geometric height
  ...
  subroutine init_constants(regional, isBrams)
!$$$  subprogram documentation block
!                .      .    .                                       .
...
!   Define regional constants here
    if (regional) then
       ...
       if(isBrams)then
!         Put some BRAMS constants at GSI constants
          rearth  = 6367000.0_r_kind
          grav    = 9.80665_r_kind
          rd      = 287.0_r_kind
          rv      = 461.0_r_kind
          cp      = 1004.0_r_kind
          ...
          cliq    = 4.1855e+3_r_kind ! using the same constant of GSI Global
          cp_mass = cp
          rd_over_cp_mass = rd / cp
